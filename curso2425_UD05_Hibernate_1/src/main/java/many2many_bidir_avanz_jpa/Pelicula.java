...
public class Pelicula implements Serializable {
	...
	public Set<Protagonista> getColaboracionesEnLaPelicula() {
		return colaboracionesEnLaPelicula;
	}

	public void setColaboracionesEnLaPelicula(Set<Protagonista> actoresEnLaPelicula) {
		this.colaboracionesEnLaPelicula = actoresEnLaPelicula;
	}
	
	public void aniadirColaboracion(Protagonista prot) {
		colaboracionesEnLaPelicula.add(prot);
	}
	
	public void quitarColaboracion(Protagonista prot) {
