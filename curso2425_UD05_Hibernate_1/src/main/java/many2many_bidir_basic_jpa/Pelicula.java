...
public class Pelicula implements Serializable {
	...
	@JoinTable(name = "interpretes", joinColumns = @JoinColumn(name = "cod_pelicula"), inverseJoinColumns = @JoinColumn(name = "cod_actor"))
	private Set<Actor> actoresEnLaPelicula = new HashSet<Actor>();
	...
	public Set<Actor> getActoresEnLaPelicula() {
		return actoresEnLaPelicula;
	}

	public void setActoresEnLaPelicula(Set<Actor> actoresEnLaPelicula) {
		this.actoresEnLaPelicula = actoresEnLaPelicula;
	}

	public void aniadirActor(Actor actor) {
		actoresEnLaPelicula.add(actor);
		actor.aniadirPelicula(this);
	}

	public void quitarActor(Actor actor) {
		actoresEnLaPelicula.remove(actor);
		actor.quitarPelicula(this);
	}
	...
	/*
	 * Consideramos los 4 atributos porque el codigo no lo informamos explicitamente y por tanto si
	 * tengo varias peliculas para un director todas ellas tienen codigo null hasta que las persista
	 * la BD y como uso un set para guardar las peliculas de un director , al reyenar ese set
	 * machaca las peliculas quedandose unicamente la ultima añadida
	 */
	@Override
	public int hashCode() {
	...
	public boolean equals(Object obj) {
		...
		return codigo_pelicula == other.codigo_pelicula && Objects.equals(fecha_grab, other.fecha_grab)
