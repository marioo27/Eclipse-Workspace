...
public class Direccion implements Serializable {
	...
	// Anadir el atributo mapedby para indicar que esta entidad no es el owner, e indicamos el
	// nombre del atributo de la clase OWNER (Actor) que se corresponde con la clase FK
	// Por defecto el fetch es eager, es decir recupero los actores de las drecciones sin saber si a
	// futuro vamos a usarlo.
	...
	public String toString() {
		...
		return "Direccion [codigo_direccion=" + codigo_direccion + ", calle=" + calle + ", num=" + num + ", actor="
				+ actor + "]";
	}
