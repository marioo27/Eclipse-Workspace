...
public class Actor implements Serializable {
	...
	@ManyToMany(mappedBy = "actoresEnLaPelicula", cascade = CascadeType.PERSIST)
	private Set<Pelicula> peliculasDelActor;

	public Actor() {
		peliculasDelActor = new HashSet<Pelicula>();
	}
	...
	public Set<Pelicula> getPeliculasDelActor() {
		return peliculasDelActor;
	}

	public void setPeliculasDelActor(Set<Pelicula> peliculasDelActor) {
		this.peliculasDelActor = peliculasDelActor;
	}

	public void aniadirPelicula(Pelicula peli) {
		peliculasDelActor.add(peli);
	}

	public void quitarPelicula(Pelicula peli) {
		peliculasDelActor.remove(peli);
	}
